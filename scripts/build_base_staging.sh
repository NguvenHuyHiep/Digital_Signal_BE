...
ssh -i ../ssh/ssh_anfovn_admin -p 228 $_user@$_remote <<'EOL'
  ...
  docker build -t aninfosys.asia:8082/lpdev/dsd/dsd-backend-base-staging:latest  -f ./docker/Dockerfile_staging .
