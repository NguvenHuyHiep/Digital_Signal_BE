...
public class AdminScheduleController {
  ...
  @Operation(summary = "Delete a schedule by id", description = "Return OK")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(summary = "Delete schedule by id", description = "Return deleted schedule")
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Successfully delete  schedule"),
        @ApiResponse(responseCode = "500", description = "Internal Server Error")
      })
  @DeleteMapping()
  public ResponseEntity<BaseOutput<String>> deleteByIds(
    ...
    scheduleService.deleteByIds(ids);
    return ResponseEntity.ok(
        BaseOutput.<String>builder()
            .message(HttpStatus.OK.toString())
            .status(ResponseStatus.SUCCESS)
